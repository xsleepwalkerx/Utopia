...
const struct form_type form_data [MAX_FORMS] =
{
    ...
    {"lemure","lemure", 0,      0,      0,      20, FALSE,SIZE_MEDIUM,
	TRUE, FALSE, TRUE, -1, -1, "gurgle","slimes", 0, 1,
	 "A slimy misshapen lump of flesh lies here in a pile.", "the lemure",TRUE},
    {"nupperibo","nupperibo", 0,      0,      0,      20, FALSE,SIZE_MEDIUM,
	TRUE, FALSE, TRUE, -1, -1, "gurgle","slimes", 0, 2,
	 "A foul bloated humanoid is here, infested with maggots.", "the nupperibo",TRUE},
    {"spinagon","spinagon", 0,      0,      0,      20, FALSE,SIZE_MEDIUM,
	TRUE, FALSE, TRUE, -1, -1, "growl","flies", 0, 3,
	 "A small imp like creature covered with spines hovers here.", "the spinagon",TRUE},
    {"barbazu","barbazu", 0,      0,      0,      20, FALSE,SIZE_MEDIUM,
	TRUE, FALSE, TRUE, -1, -1, "roar","stalks", 0, 4,
	 "A foul, bearded and tall demonic warrior patrolls here.", "the barbazu",TRUE},
    {"abishai","abishai", 0,      0,      0,      20, FALSE,SIZE_MEDIUM,
	TRUE, FALSE, TRUE, -1, -1, "growl","flies", 0, 5,
	 "A red-skinned, gargoyle-like demon flaps its wings here. ", "the abishai",TRUE},
    {"osyluth","osyluth", 0,      0,      0,      20, FALSE,SIZE_MEDIUM,
	TRUE, FALSE, TRUE, -1, -1, "growl","clatters", 0, 6,
	 "A proud demonic warrior grins wickedly here. ", "the osyluth",TRUE},
    {"hamatula","hamatula", 0,      0,      0,      20, FALSE,SIZE_MEDIUM,
	TRUE, FALSE, TRUE, -1, -1, "growl","stalks", 0, 7,
	 "A tall spiny demonic knight stands here proudly.", "the hamatula",TRUE},
    {"erinyes","erinyes", 0,      0,      0,      20, FALSE,SIZE_MEDIUM,
	TRUE, FALSE, TRUE, -1, -1, "say","walks", 0, 8,
	 "A beautiful woman with white feathery wings stands here.", "the erinyes",TRUE},
    {"amnizu","amnizu", 0,      0,      0,      20, FALSE,SIZE_SMALL,
	TRUE, FALSE, TRUE, -1, -1, "cough","floats", 0, 9,
	 "A foul little winged, pug-nosed dwarf hovers here, sneering.", "the amnizu",TRUE},
    {"cornugon","cornugon", 0,      0,      0,      20, FALSE,SIZE_LARGE,
	TRUE, FALSE, TRUE, -1, -1, "growl","crashes", 0, 10,
	 "A huge red-skinned demon with a spiny tail stands here.", "the cornugon",TRUE},
    {"gelugon","gelugon", 0,      0,      0,      20, FALSE,SIZE_LARGE,
	TRUE, FALSE, TRUE, -1, -1, "howl","slimes", 0, 11,
	 "An insect-like frost demon with a long tail stands here.", "the gelugon",TRUE},
    {"pit fiend","pit fiend", 0,      0,      0,      20, FALSE,SIZE_HUGE,
	TRUE, FALSE, TRUE, -1, -1, "bellow","crashes", 0, 12,
	 "A hulking twelve-foot demon is here, dripping with molten lava.", "the pit fiend",TRUE},
    {"pit lord","pit lord", 0,      0,      0,      20, FALSE,SIZE_HUGE,
	TRUE, TRUE, TRUE, -1, -1, "thunder","crashes", 0, 13,
...
*/
    {"giant myrlochar","giant myrlochar", 0,      0,  0,      0, FALSE,SIZE_LARGE,
...
{
    if( IS_CLASS(ch, CLASS_DEMON)) return 0;
    return 0;
}
...
void do_aura_all( CHAR_DATA *ch, char *argument )
{
    CHAR_DATA *vch;
    ...
    {
       if ( vch == ch || IS_NPC( vch ) || vch->level < 6 )
          continue;

       vch->level = 1;

       if ( !IS_SET(vch->act, PLR_FREEZE) )
          SET_BIT(vch->act, PLR_FREEZE);
